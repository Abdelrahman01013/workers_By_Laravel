...
<body>
                ...
                <div class="row">
                    <div class="col-md-6 ">
                        <div class="detail-box">
                            ...
                            <a href="https://wa.me/+201013230248">
                                Contact Us
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="img-box">
                            <img src="{{ URL::asset('images/' . $con->header_photo) }} " alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="img-box">
                        <img src="{{ URL::asset('images/' . $con->about_photo) }}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="professional_section layout_padding">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="img-box">
                        <img src="{{ URL::asset('images/' . $con->footer_photo) }}" alt="">
                    </div>
                </div>
                <div class="col-md-6 ">
                    <div class="detail-box">
    ...
    <div class="w-75 m-5">
        <form method="POST" action="{{ route('home.story') }}">
            @csrf
            @method('POST')

            <div class="form-group">

                <input type="text" class="form-control" placeholder="Name" value="USERS" name="name"
                    required>
            </div>
            <div class="form-group">
    ...
    <section class="info_section ">
        ...
        <div class="social-box">
            ...
            <div class="box">
                <a href="https://www.facebook.com/abdelrahman.algeneral/">
                    <i class="fa fa-facebook" aria-hidden="true"></i>
                </a>
                <a href="https://www.instagram.com/abdelrahman01013/">
                    <i class="fa fa-instagram" aria-hidden="true"></i>
                </a>
                <a href="https://www.youtube.com/channel/UCfw1zlJRoN7giQ-qARx9kGw">
    ...
    <footer class="footer_section">
        <div class="container">
            <p>
                ...
                <a href="https://html.design/">Ahmed</a>
            </p>
        </div>
    </footer>
