            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="dashboard"><i class="bx bx-user-circle"></i>Profile</a>
                        <a class="dropdown-item" href="profile"><i class="bx bx-cog"></i> Edit Profile</a>
                        <a class="dropdown-item" href="admin"><i class="bx bxs-inbox"></i>Inbox</a>

                        <form id="logout-form" action="{{ route('logout') }}" method="POST">
                            <button type="submit" class="dropdown-item" href="{{ route('logout') }}"><i
                                    class="bx bx-log-out"> Sign Out</i>
                            </button>
                            @csrf
                        </form>
